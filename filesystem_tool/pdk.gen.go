...
func _ListResourceTemplates() int32 {
	var err error
	_ = err
	output, err := ListResourceTemplates()
	if err != nil {
		pdk.SetError(err)
		return -1
	}
...
//
type ListResouceRequestParams struct {
...
type ListResourceRequest struct {
	Method string                   `json:"method,omitempty"`
	Params ListResouceRequestParams `json:"params,omitempty"`
}
...
type ListResourceTemplatesRequst struct {
	Method string                             `json:"method,omitempty"`
